# Button 按钮
  ...
  <div style="margin-bottom:20px;">
    <NainButton color="blue">主要按钮</NainButton>
    <NainButton color="green">绿色按钮</NainButton>
    <NainButton color="gray">灰色按钮</NainButton>
    <NainButton color="yellow">黄色按钮</NainButton>
    <NainButton color="red">红色按钮</NainButton>
  </div>
